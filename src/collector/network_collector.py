...
FullDrop =  "FullDrop1=$(cat /proc/net/netstat | grep 'TcpExt:' | awk '{print$77}' | tail -n 1); sleep 5; FullDrop2=$(cat /proc/net/netstat | grep 'TcpExt:' | awk '{print$77}' | tail -n 1); echo $(( FullDrop2 - FullDrop1))"
